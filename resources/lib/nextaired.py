            ...
            for item in trakt_results:
                ...
                for i in local_media_data:
                    if (
                        ...
                        or str(tvdb_id) == i[1]
                        or str(imdb_id) == i[2]
                        or (tvshowtitle in [i[4], i[5]] and year == i[6])
                    ):
                        episode_cache_key = (
                        ...
                        if episode_query:
                            ...
                            episode_query["overview"] = tmdb_fallback_info(
                                episode_query, "overview"
                            )
                            episode_query["name"] = tmdb_fallback_info(
                                episode_query, "name"
                            )
